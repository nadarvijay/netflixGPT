...
const VideoTitle = ({ title, summary }) => {
    ...
    return (
        <div className='w-screen aspect-video pl-5 sm:pl-10 md:pl-15 lg:pl-24 absolute pt-[40%] sm:pt-[20%] bg-gradient-to-r from-black-200 text-white'>
            <div className='text-2xl sm:text-5xl font-bold sm:mb-5'>{title}</div>
            <div className='hidden sm:hidden md:hidden lg:block text-lg w-[40%]'>{summary}</div>
